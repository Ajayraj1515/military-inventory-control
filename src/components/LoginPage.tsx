    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-400 mt-4">Secure Access Portal</p>
        </div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-700">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-slate-400">commander1 / cmd123</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300">Logistics:</span>
                  <span className="text-slate-400">logistics1 / log123</span>
                </div>
              </div>
            </div>
          </CardContent>
